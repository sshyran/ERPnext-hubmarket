...
def add_item_to_seller_favourites(hub_seller, hub_item_code):
    # Update favourite log

    update_hub_favourite_log(hub_seller, hub_item_code, 1)

    # Santosh removed Mat from favourites
    # Santosh added Wheel to favourites
    # Santosh removed Speaker from favourites
    # Santosh added Mat to favourites
    # Santosh added Speaker to favourites


@frappe.whitelist()
def remove_item_from_seller_favourites(hub_seller, hub_item_code):
    update_hub_favourite_log(hub_seller, hub_item_code, 0)
